...
## Dataset
* The dataset contains responses from over 28,000 individuals across various  industries, job roles, experience levels, and geographic regions.
* 9000+ Rows
* 16 Attribute columns
...
:white_small_square:Top Selling Products : Office Supplies is the top category for sales and Chairs and Phones as the top-performing products

:white_small_square:Ship Mode preference : Standard Class shipping mode is the top ship mode preferred by customers. Same Day and First Class being lower sales contributions

:white_small_square:Regional Insights : Top-performing states include California and New York. The West and East regions generate the highest total revenue

:white_small_square:Trends Over Time : Sales have shown a steady increase, particularly in Q4 of each year

:white_small_square:Impact of discounts : Over-discounting reduces profitability

:white_small_square:Profitability : ​Each category contributes variably to overall profit, with Technology showing potential for maximization through refined strategies
